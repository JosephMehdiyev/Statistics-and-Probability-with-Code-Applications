...
\section{Exercises}
     ...
     1. Suppose a coin has probability  $p$ of getting heads. Logically, if we tossed coin in a large sum, the proportion of heads would be near $p$. Write a simulation with $n$ tosses and $p$ probability to show the claim. \\
    \textbf{Solution}
    \inputminted[bgcolor = bg]{python}{src/chapter1/1.py} \\
    \begin{center} \input{src/chapter1/fig1.pgf} \end{center}
    \embed{src/chapter1/1.py}{Source}  
